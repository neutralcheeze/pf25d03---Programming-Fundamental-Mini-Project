 ...
 */
public enum Seed5 {   // to save as "Seed.java"
    CROSS("X", "images/YONA.gif"),   // displayName, imageFilename
    NOUGHT("O", "images/MINION.gif"),
    NO_SEED(" ", null);
    ...
    private Seed5(String name, String imageFilename) {
